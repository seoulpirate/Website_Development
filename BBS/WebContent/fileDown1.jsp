...
<body>
	<%
		...
		String savePath = "folderName";	// case(2)
		...
		//String sFilePath = savePath + "\\" + fileName; // ex)c:...\\folderName\\outputfile	// case(1)
		...
		try {
			...
			byte[] temp = new byte[1024 * 1024 * 5]; // 5M
			...
			// 서블릿으로 변환하는 과정에서 JSP자체 outputStream 제거 미리 한다.
			out.clear();
			...
			script.println("alert('파일처리에 오류가 생겼습니다.')");
